...
def get_data_loader(discretizer, normalizer, dataset_dir, batch_size):
    train_ds = EHRdataset(discretizer, normalizer, 'data/phenotyping/train_listfile.csv', dataset_dir)
    val_ds = EHRdataset(discretizer, normalizer, 'data/phenotyping/val_listfile.csv', dataset_dir)
